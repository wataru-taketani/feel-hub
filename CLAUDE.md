...
1. **MEMORY.md 更新**: 新しく判明した事実（API仕様、バグ原因、アーキテクチャ変更等）があれば更新
2. **CLAUDE.md TODO 更新**: 完了したTODOはチェック済み/削除、新規TODOは追記
3. **Lambda変更時**: `aws logs tail /aws/lambda/feel-hub-lambda-prod-checkCancellation --since 3m --format short` でログ確認
4. **Vercel変更時**: デプロイ正常完了を確認
